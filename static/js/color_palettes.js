const color_palette = [
  ...
  function setColors(palette){
    ...
    var screen_svg = getScreenSVG(palette[0], palette[1], palette[2], palette[3], "#ffffff");
    $("#screen-svg").remove();
