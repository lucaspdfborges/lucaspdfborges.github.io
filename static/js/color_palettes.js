...
const color_palette = [
  ...
  const fonts_link = '<link href="https://fonts.googleapis.com/css2?family=Amatic+SC&family=Barlow+Condensed:wght@300&family=Baskervville&family=Beth+Ellen&family=Bungee+Inline&family=Cinzel&family=Cormorant+Infant&family=Dancing+Script&family=Fredericka+the+Great&family=IM+Fell+English+SC&family=Jua&family=Julius+Sans+One&family=Jura:wght@300&family=Kelly+Slab&family=Lekton&family=Londrina+Shadow&family=Monoton&family=Nixie+One&family=Pacifico&family=Poiret+One&family=Press+Start+2P&family=Quantico&family=Rajdhani:wght@300&family=Raleway:wght@300&family=Rubik+Mono+One&family=Rye&family=Sacramento&family=Sarpanch&family=Wire+One&display=swap" rel="stylesheet"> ';

  const font_family_collection = [
    {'name': 'Dancing Script', 'css': "font-family: 'Dancing Script', cursive;"},
    {'name': 'Amatic SC', 'css': "font-family: 'Amatic SC', cursive;"},
    {'name': 'Pacifico', 'css': "font-family: 'Pacifico', cursive;"},
    {'name': 'Sacramento', 'css': "font-family: 'Sacramento', cursive;"},
    {'name': 'Beth Ellen', 'css': "font-family: 'Beth Ellen', cursive;"},
    {'name': 'Cinzel', 'css': "font-family: 'Cinzel', serif;"},
    {'name': 'Josefin Slab', 'css': "font-family: 'Josefin Slab', serif;"},
    {'name': 'Cormorant Infant', 'css': "font-family: 'Cormorant Infant', serif;"},
    {'name': 'IM Fell English SC', 'css': "font-family: 'IM Fell English SC', serif;"},
    {'name': 'Baskervville', 'css': "font-family: 'Baskervville', serif;"},
    {'name': 'Raleway', 'css': "font-family: 'Raleway', sans-serif;"},
    {'name': 'Barlow Condensed', 'css': "font-family: 'Barlow Condensed', sans-serif "},
    {'name': 'Rajdhani', 'css': "font-family: 'Rajdhani', sans-serif;"},
    {'name': 'Julius Sans One', 'css': "font-family: 'Julius Sans One', sans-serif;"},
    {'name': 'Quantico', 'css': "font-family: 'Quantico', sans-serif;"},
    {'name': 'Rubik Mono One', 'css': "font-family: 'Rubik Mono One', sans-serif;"},
    {'name': 'Jura', 'css': "font-family: 'Jura', sans-serif;"},
    {'name': 'Lekton', 'css': "font-family: 'Lekton', sans-serif;"},
    {'name': 'Jua', 'css': "font-family: 'Jua', sans-serif;"},
    {'name': 'Sarpanch', 'css': "font-family: 'Sarpanch', sans-serif;"},
    {'name': 'Wire One', 'css': "font-family: 'Wire One', sans-serif;"},
    {'name': 'Poiret One', 'css': "font-family: 'Poiret One', cursive;"},
    {'name': 'Press Start 2P', 'css': "font-family: 'Press Start 2P', cursive;"},
    {'name': 'Monoton', 'css': "font-family: 'Monoton', cursive;"},
    {'name': 'Kelly Slab', 'css': "font-family: 'Kelly Slab', cursive;"},
    {'name': 'Fredericka the Great', 'css': "font-family: 'Fredericka the Great', cursive;"},
    {'name': 'Nixie One', 'css': "font-family: 'Nixie One', cursive;"},
    {'name': 'Bungee Inline', 'css': "font-family: 'Bungee Inline', cursive;"},
    {'name': 'Rye', 'css': "font-family: 'Rye', cursive;"},
    {'name': 'Londrina Shadow', 'css': "font-family: 'Londrina Shadow', cursive;"}
  ];
